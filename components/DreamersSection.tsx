...
export default function DreamersSection() {
  ...
  return (
    <section id="approach" className="py-12 md:py-16 bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          <div className="border border-gray-100 rounded-3xl bg-gray-50 p-4 md:p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              {/* Placeholder Image */}
              <div className="h-[220px] md:h-[380px] rounded-3xl shadow-lg bg-gradient-to-br from-blue-900 via-blue-700 to-orange-500 flex items-center justify-center">
